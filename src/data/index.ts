...
const _allChapters = [...ttkChapters, ...lnChapters, ...ttvChapters, ...bgtChapters, ...poetChapters, ...ddkChapters];
const _allSentences = [...ttkSentences, ...lnSentences, ...ttvSentences, ...bgtSentences, ...poetSentences, ...ddkSentences];
...
export function getOverrides(sentenceId: string): Record<string, [string, string, string]> | undefined {
  return ttkOverrides[sentenceId] || lnOverrides[sentenceId] || ttvOverrides[sentenceId] || bgtOverrides[sentenceId] || poetOverrides[sentenceId] || ddkOverrides[sentenceId];
}
